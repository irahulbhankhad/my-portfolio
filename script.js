...
function initCustomCursor() {
    ...
    document.addEventListener('pointermove', (event) => {
        ...
        const interactive = event.target.closest('a, button, .btn, .social-icon, .tool-item, .project-card, .skill-item, .filter-btn, input, textarea, .hamburger, .resume-card, .resume-download-card');
