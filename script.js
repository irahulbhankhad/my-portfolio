...
if (typeof VanillaTilt !== 'undefined') {
    VanillaTilt.init(document.querySelectorAll(".project-card, .tool-item, .skill-card, .github-card, .repo-card, .resume-card, .resume-download-card"), {
        max: 8,
        speed: 400,
        glare: true,
        "max-glare": 0.15,
...
const premiumTiltTargets = document.querySelectorAll(
    '.about .stat, .skill-category, .tool-item, .project-card, .github-card, .repo-card, .certificate-card, .contact-form, .resume-card, .resume-download-card'
);
